...
public class Class_04_PreInPosTraversal {
    ...
    public static void posOrderRecur2(Node head) {
        ...
        while (!stack.isEmpty()) {
            ...
            if (helpNode.left != null) stack.push(helpNode.left);
            if (helpNode.right != null) stack.push(helpNode.right);
        }
